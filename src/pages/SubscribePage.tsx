...
/** The lead funnel. Three stages of one page, not three pages. */
export function SubscribePage() {
  const { t } = useTranslation();
  const [stage, setStage] = useState<Stage>(QUIZ_ENABLED ? "quiz" : "form");
  ...
  // Each stage is a different height, which invalidates every ScrollTrigger's
  // start/end offset. This page owns the change, so it owns the refresh.
  useScrollRefresh([stage]);
